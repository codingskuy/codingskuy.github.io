    ...
    <div style={{ background: '#0D1117', minHeight: '100vh', color: '#F0F6FC' }}>
        ...
        >
          ...
          >
            ...
            >
              ...
              {['Code Review', 'Architecture Review', 'Security (GRC)', 'Mentoring Plan', 'Engineering Growth'].map(
                (item) => (
                  <div
                    key={item}
                    style={{
      ...
      <section style={{ maxWidth: 1160, margin: '0 auto', padding: '0 24px 100px' }}>
        ...
        >
          ...
          <div>
            {[
              { step: '01', label: 'Install Plugin', desc: 'One command inside OpenCode. Nothing leaves your workflow.' },
      ...
      <footer style={{ maxWidth: 1160, margin: '0 auto', padding: '48px 24px 40px' }}>
        ...
        >
          ...
          <div>
            ...
            {['Features', 'Learn Agent', 'Coach Agent', 'Competency Engine', 'Changelog'].map((link) => (
              <a
                key={link}
                href="#"
                className="link-underline"
